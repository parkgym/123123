...
<%
  if(count > 0){
	  ...
	  if(startPage > 5){
		  ...
		  if(search.equals("") || search == null){
%>
<a href="list1.jsp?pageNum=<%=startPage - 5 %>">[이전]</a>
<%
		  }else{
%>
<a href="list1.jsp?pageNum=<%=startPage - 5 %>">&search=<%=search %>&searchn=<%=searchn %>">[이전]</a>
<%
		  }
%>
<%
...
%>
<a href="list1.jsp?pageNum=<%=i %>&search=<%=search %>&searchn=<%=searchn %>">[<%=i %>]</a>
<%
		  }
%>
<%
	  ...
	  if(endPage < pageCount){
		  ...
		  if(search.equals("") || search == null){
%>
<a href="list1.jsp?pageNum=<%=startPage + 5 %>">[다음]</a>
<%
		  } else{
%>
<a href="list1.jsp?pageNum=<%=startPage + 5 %>&search=<%=search %>&searchn=<%=searchn %>">[다음]</a>
<%
		  }
%>
<%
