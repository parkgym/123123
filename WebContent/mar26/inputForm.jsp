...
<body>
<div id = "wrap">
<form action = "inputPro.jsp" name = "userinput" onsubmit = "return checklt()" method = "post">
<h1>★회원가입★</h1>
<div id = "body">
<table width = "500px;">
<colgroup>
...
<input type="button" value="취 소" class="inputBtn" onclick="javascript:window.location='main.jsp'" /></div>
</form></div>
</body>
</html>