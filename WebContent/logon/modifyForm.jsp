...
<form method="post" action="modifyPro.jsp" name="userinput" onsubmit="return checkIt()">
  ...
  <%}else{ %>
    <input type="text" name="email" size="60" maxlength="50" value="<%=c.getEmail() %>">
  <%} %>
      </td>
    </tr>
    <tr>
  ...
  <%if(c.getZipcode()==null){ %>
    <input type="text" name="zipcode" size="10" maxlength="20">
  <%}else{ %>
    <input type="text" name="zipcode" size="10" maxlength="20" value="<%=c.getZipcode() %>">
  <% } %>
      </td>
    </tr>
    <tr>
